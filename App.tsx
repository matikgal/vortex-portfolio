...
const LoadingScreen = () => (
	<motion.div
		className="fixed inset-0 z-[100] bg-[#ccff00] flex flex-col items-center justify-center px-4"
		exit={{ y: '-100%', transition: { duration: 0.8, ease: [0.76, 0, 0.24, 1] } }}>
		<motion.div className="overflow-hidden">
			<motion.h1
				initial={{ y: 100 }}
				animate={{ y: 0 }}
				className="text-5xl sm:text-7xl md:text-9xl font-black text-black tracking-tighter uppercase text-center">
				ŁADOWANIE
			</motion.h1>
		</motion.div>
		<motion.div
			...
			className="h-2 bg-black mt-4 max-w-[200px]"
		/>
	</motion.div>
)
					...
					<div className="relative z-0">
						...
						<div className="relative z-10 flex flex-col">
							...
							<Marquee
								text="ZŁAM SIATKĘ +"
								direction="left"
								className="bg-[#ccff00] text-black py-4 rotate-2 scale-105 z-20 border-y-4 border-black"
								speed={10}
								filled={true}
							/>
							...
							<div className="py-20 bg-[#050505]">
								<Marquee
									text="NAGRADZANY DESIGN /// CYFROWY BRUTALIZM ///"
									direction="right"
